      ...
      {videos && room && (
        ...
        <div className="video-room">
          ...
          <svg className="self-mute-button bi bi-mic-fill"
             xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="white"  viewBox="0 0 16 16">
          ...
          :
          <div onClick={() => setMyAudioIsOn(selfMuteToggle(myStream))} className="svg-container svg-mute-container">
          <svg className="self-mute-button bi bi-mic-mute-fill" xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="white"  viewBox="0 0 16 16">
        ...
        <div onClick={() => setMyVideoIsOn(selfVideoToggle(myStream))} className=" svg-container svg-video-container">
         <svg  className="video-svg bi bi-camera-video-fill"xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="white" viewBox="0 0 16 16">
          ...
          :
          <div onClick={() => setMyVideoIsOn(selfVideoToggle(myStream))} className=" svg-container svg-video-container">
         <svg className="video-svg bi bi-camera-video-off-fill" xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="white"  viewBox="0 0 16 16">
          ...
          {myStream?.getVideoTracks()[0] && (
            ...
            <svg className="svg-sharescreen bi bi-upload " xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="white"  viewBox="0 0 16 16">
